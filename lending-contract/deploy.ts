...
const PRIVATE_KEY  = 'cRtEjqNXJ23Hst6r6cM7BQPJfzL113hNLcukpxXwCSQmGcRbAied'; // ganti dengan WIF key kamu
...
async function main(): Promise<void> {
  ...
  if (PRIVATE_KEY === 'cRtEjqNXJ23Hst6r6cM7BQPJfzL113hNLcukpxXwCSQmGcRbAied') {
